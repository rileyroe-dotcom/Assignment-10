const display = document.getElementById("timeDisplay") as HTMLElement;
...
const lapButton = document.getElementById("lapBtn") as HTMLButtonElement;
const clearLapsButton = document.getElementById("clearLapsBtn") as HTMLButtonElement;
const laps = document.getElementById("lapsList") as HTMLUListElement;
